...
urlpatterns = [
    ...
    path('productos/', produccion_views.producto, name='producto'),
    path('crear/', produccion_views.producto_crear, name='producto_crear'),
    path('producto/<int:pk>/', produccion_views.producto_detalle, name='producto_detalle'),
    path('producto/<int:pk>/editar/', produccion_views.producto_act, name='producto_act'),
    path('producto/<int:pk>/eliminar/', produccion_views.producto_delete_ajax, name='producto_eliminar'),
    ...
    path('proveedor/<int:pk>/', proveedores_views.proveedor_detalle, name='proveedor_detalle'),
    path('proveedor/<int:pk>/editar/', proveedores_views.proveedor_act, name='proveedor_act'),
    path('proveedor/<int:pk>/eliminar/', proveedores_views.proveedor_eliminar, name='proveedor_eliminar'),
